...
import { HorizontalView, VerticalView, DataView, FlowView, ThreadView, MapView, ReportView, SlideView } from '@/components/views';
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {currentView !== 'horizontal' && currentView !== 'vertical' && currentView !== 'data' && currentView !== 'flow' && currentView !== 'thread' && currentView !== 'map' && currentView !== 'report' && currentView !== 'slide' && (
